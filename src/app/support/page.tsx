...
const FAQ_ITEMS = [
  {
    ...
    questions: [
      {
        q: "料金プランについて教えてください",
        a: "有利会員になるには1ヶ月プラン（¥1,980税込）、3ヶ月プラン（¥4,650税込）、6ヶ月プラン（¥8,100税込）、12ヶ月プラン（¥13,800税込）の各種定額プランをご用意しています。長期プランほどお得にご利用いただけます。※全ての定額プランは、クレジットカード一括払い決済のみご利用いただけます。※有料会員様は、いかなる理由の場合でも、ご解約による返金対応は一切受けつけておりません。"
      },
      {
        q: "支払い方法は何が使えますか？",
      ...
      {
        q: "有料会員の解約はいつでもできますか？",
        a: "はい、いつでも有料会員の解約は可能です。有料会員を解約するにはログインしてマイページ画面より解約手続きをしてください。有利会員の解約後も契約期間終了までNUKUNEのサービスはご利用いただけます。※いかなる理由の場合でも、有利会員解約での返金対応は一切受けつけておりません。"
      }
    ]
  },
  {
    ...
    questions: [
      {
        q: "プロフィールの変更方法は？",
        a: "プロフィールページの「編集」ボタンから、写真や各種設定などを変更できます。"
      },
      {
